...
-- =============================================
CREATE PROCEDURE [dbo].[_cxp_prc_acumularSaldosPorFecha]
	@idtran AS INT
AS
...
DELETE FROM ew_cxp_transacciones_saldos WHERE idtran = @idtran
...
INSERT INTO ew_cxp_transacciones_saldos (
	idtran
	,fecha
	,saldo
	,idmov2
...
BEGIN
	...
	UPDATE ew_cxp_transacciones_saldos SET
		saldo = @saldo
	WHERE
		idtran = @idtran
