...
-- Description:	Procesa movimiento no aplicado de ew_inv_transacciones_mov
-- =============================================
ALTER PROCEDURE [dbo].[_inv_prc_procesarInvTransaccionesMov]
	@idr AS INT
AS
