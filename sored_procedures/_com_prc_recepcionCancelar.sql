...
LEFT JOIN ew_articulos a ON a.idarticulo = ew_com_transacciones_mov.idarticulo
...
SELECT idmov,idmov2,'cantidad_surtida',ISNULL(cantidad_recibida,0)*(-1)
FROM ew_com_transacciones_mov
WHERE idtran = @idtran
