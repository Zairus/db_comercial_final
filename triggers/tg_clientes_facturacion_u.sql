...
GO
IF OBJECT_ID('tg_clientes_facturacion_u') IS NOT NULL
BEGIN
	DROP TRIGGER tg_clientes_facturacion_u
END
GO
-- =============================================
-- Author:		Paul Monge
...
-- =============================================
CREATE TRIGGER [dbo].[tg_clientes_facturacion_u]
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			SELECT @mensaje = 'EL RFC ' + @rfc + ' ya se encuentra registrado con otro codigo de cliente. Corrija e intente guardar de nuevo.'
