...
-- =================================================================
ALTER TRIGGER [dbo].[tg_cxc_transacciones_id] 
...
DECLARE tg_cxc_transacciones_id CURSOR FOR
	SELECT
		m.idr
		, m.idtran
		, m.idmov
...
OPEN tg_cxc_transacciones_id

FETCH NEXT FROM tg_cxc_transacciones_id INTO 
	@idr
	, @idtran
	, @idmov
...
CLOSE tg_cxc_transacciones_id
DEALLOCATE tg_cxc_transacciones_id
GO
EXEC sp_settriggerorder @triggername=N'[dbo].[tg_cxc_transacciones_id]', @order=N'First', @stmttype=N'INSERT'
