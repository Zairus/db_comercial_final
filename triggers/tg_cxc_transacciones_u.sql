...
-- ==========================================================================================
ALTER TRIGGER [dbo].[tg_cxc_transacciones_u]
...
BEGIN
	...
	--------------------------------------------------------------------------------
	DECLARE cur_tg_cxc_transacciones_u CURSOR FOR
		SELECT
			i.idtran
		FROM 
			inserted AS  i
	...
	OPEN cur_tg_cxc_transacciones_u

	FETCH NEXT FROM cur_tg_cxc_transacciones_u INTO 
		@idtran
	...
	BEGIN
		...
		INSERT INTO ew_sys_transacciones2	
			(idtran, idestado, idu)
		VALUES
			(@idtran, dbo.fn_sys_estadoID('PAGA'), @idu)
		
		FETCH NEXT FROM cur_tg_cxc_transacciones_u INTO 
			@idtran
	END

	CLOSE cur_tg_cxc_transacciones_u
	DEALLOCATE cur_tg_cxc_transacciones_u
